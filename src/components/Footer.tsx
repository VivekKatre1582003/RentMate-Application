...
const Footer = () => {
  return (
    <footer className="bg-white border-t border-muted">
      <div className="rentmate-container py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Access thousands of items without the cost of ownership. Find exactly what you need, when you need it.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-muted flex flex-col md:flex-row md:items-center justify-between">
